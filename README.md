...
Personal portfolio site for **Vishwas Tiwari** (AI enthusiast & developer). Dark, **cherry red** accent **“Cyber‑Neural”** UI inspired by a Google Stitch design pass: glass-style surfaces, **Svetze** (display) / Inter / **Geist Sans** (labels & UI accents) typography, and a shared **neural canvas** graphic between the landing intro and hero.
